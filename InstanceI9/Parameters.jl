using JuMP, Printf, LinearAlgebra, Random, Gaston, Gurobi, JLD2, FileIO, Statistics
...
frete_rodo = frete_rodo*[1,1.05,1.05^2]
#
frete_ferro=0.072*1.6204
frete_ferro = frete_ferro*[1,1.05,1.05^2]
#
frete_hidro=0.03181*1.6204
frete_hidro = frete_hidro*[1,1.05,1.05^2]
#
frete_hidro_ex=0.5*0.03181*1.6204
frete_hidro_ex = frete_hidro_ex*[1,1.05,1.05^2]
#
Preco_ICMS = [705 1.05*705 1.05*1.05*705]
Custo_ICMS = zeros(estados, estados, length(T))
for e = 1:estados, elinha = 1:estados, t ∈ T
    Custo_ICMS[e, elinha,t] = Preco_ICMS[t] * Aliquota_ICMS[e,elinha]
end
...
cT = zeros(n,n,length(T))
for i in 1:n, j in 1:n, t ∈ T
